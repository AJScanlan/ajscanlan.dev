---
title: "What is ConversationEngine?"
...
`ConversationEngine` will be an LLM chat interface with a frontend built in Swift and SwiftUI for iOS, and a backend built in Rust.
...
I plan on building `ConversationEngine` piece by piece, from the ground up, with blog posts detailing my decisions, my thought processes, my learnings and my failures.
...
The project can be found on Github: [ConversationEngine](https://github.com/AJScanlan/ConversationEngine)